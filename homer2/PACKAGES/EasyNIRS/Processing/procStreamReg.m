...
'@ hmrMotionCorrectPCArecurse_Ch_dual [dod,tIncAuto,svsmc,nSVmc,tIncAuto0] (dod,t,SD,tIncMan tMotion %0.1f 0.5 tMask %0.1f 1.0 STDEVthresh %0.1f 20.0 AMPthresh %0.2f 5 nSV %.2f 0.97 maxIter %d 5',...
'@ hmrMotionCorrectPCArecurseCh_SG [dod,tIncAuto,svsmc,nSVmc,tIncAuto0] (dod,t,SD,tIncMan nSV %.2f 0.97 maxIter %d 3 FrameSize_sec %d 10',...
'@ hmrMotionCorrectSpline [dod] (dod,t,SD,tIncChAuto p %.2f .99',...
'@ hmrMotionCorrectSplineSG [dod] (dod,d,t,SD p %.2f .99 FrameSize_sec %d 10',...
'@ hmrMotionCorrectCbsi [dc] (dc,SD flagSkip %d 0',...
'@ hmrMotionCorrectRLOESS [dod] (dod,t span %.2f 0.02',...
'@ hmrMotionCorrectSG [dod] (dod,t FrameSize_sec %d 10',...
