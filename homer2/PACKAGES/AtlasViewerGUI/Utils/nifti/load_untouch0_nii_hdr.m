...
function [ dime ] = image_dimension(fid)
    ...
    dime.vox_units  = deblank(fread(fid,4,'*char')');
    dime.cal_units  = deblank(fread(fid,8,'*char')');
...
function [ hist ] = data_history(fid)
    ...
    hist.generated   = deblank(fread(fid,10,'*char')');
    hist.scannum     = deblank(fread(fid,10,'*char')');
    hist.patient_id  = deblank(fread(fid,10,'*char')');
    hist.exp_date    = deblank(fread(fid,10,'*char')');
    hist.exp_time    = deblank(fread(fid,10,'*char')');
    hist.hist_un0    = deblank(fread(fid, 3,'*char')');
