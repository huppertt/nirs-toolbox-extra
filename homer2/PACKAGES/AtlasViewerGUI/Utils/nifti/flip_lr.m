...
%  to LAS orientation to satisfy the legend programs or processes.
%
%  With 'flip_lr.m', you can convert any ANALYZE or NIfTI (no matter 3D
%  or 4D) file to an L-R flipped NIfTI file. Basically, the affine matrix
%  in the flipped NIfTI file is "fooled", so it believes that the current
%  orientation (LAS) is a RAS orientation.
%
