...
switch(computer('arch'))
    case 'win64'
        [v2, T_vert2vox] = xform_apply_vol_smooth_64bit(v1, T1, mode);
    case 'win32'
        [v2, T_vert2vox] = xform_apply_vol_smooth_32bit(v1, T1, mode);
    case 'glnxa64'
        [v2, T_vert2vox] = xform_apply_vol_smooth_64bit(v1, T1, mode);
    otherwise
        [v2, T_vert2vox] = xform_apply_vol_smooth_64bit(v1, T1, mode);
...
% ---------------------------------------------------------------
function [v2, T_vert2vox] = xform_apply_vol_smooth_64bit(v1, T1, mode)
...
% If transformed volume size (v2_gridsize) is not given, then 
% calculate it based on source volume size. 
bbox_v1_grid = [...
                    1     1     1; ... 
                    1     1 Dz_v1; ... 
                    1 Dy_v1     1; ... 
...
% ---------------------------------------------------------------
function [v2, T_vert2vox] = xform_apply_vol_smooth_32bit(v1, T1, mode)
