function varargout=nirs_spm_conman(varargin)
...
if (nargin==0) | ~ischar(varargin{1})
    %=======================================================================
    % [I,xCon] = nirs_spm_conman(xX,xCon,STATmode,n,Prompt,Mcstr,OK2chg)
    ...
    [F,cF] = nirs_spm_conman('Initialise','on',SPM,STATmode,n,Prompt,Mcstr,OK2chg);
    ...
    nirs_spm_conman('Initialise','off');
...
switch lower(varargin{1}), case 'initialise'
    %=======================================================================
    % [F,cF] = nirs_spm_conman('Initialise',Vis,xX,xCon,STATmode,n,Prompt,Mcstr,OK2chg)
    ...
    switch lower(Vis), case 'close'
        ...
        case 'on'
            ...
            STAT = nirs_spm_conman('TFA',F,'',STATmode);		%-Init. TFA buttons
            set(H.hPrompt,'String',Prompt,'UserData',n)	%-Set prompt
            nirs_spm_conman('ImDesMtx',xX,H.hDesMtxAx)		%-Depict DesMtx
            nirs_spm_conman('ImParEst',xX,H.hParEstAx)		%-Parameter estimability
            nirs_spm_conman('ListCon',H.hConList,xCon,STAT,[])	%-List contrasts
            if OK2chg, tmp='on'; else, tmp='off'; end	%-OK to change xCon?
            set(H.hNew,'Enable',tmp)			%-En/dis-able change UI
            %-****	if isempty(xCon), nirs_spm_conman(); end		%-Go straight to DNewUI
...
%       est  = spm_SpUtil('IsCon',xX.xKXs);
    ...
    case 'listcon'
        %=======================================================================
        % nirs_spm_conman('ListCon',hConList,xCon,STAT,I)
        ...
        nirs_spm_conman('GraphCons',xCon,Q(q),get(hConList,'Parent'))
        nirs_spm_conman('StatusLine',get(hConList,'Parent'))


        %=======================================================================
    case 'graphcons'
        %=======================================================================
        % nirs_spm_conman('GraphCons',xCon,I,F)
    ...
    case 'statusline'
        %=======================================================================
        % nirs_spm_conman('StatusLine',F,str,col)
    ...
    case 'conlist_cb'
        ...
        if strcmp(get(F,'SelectionType'),'open'), nirs_spm_conman('Done_CB'), end


        %=======================================================================
    case {'tfa','d_tf'}
        %=======================================================================
        % STAT = nirs_spm_conman('TFA')
        % STAT = nirs_spm_conman('TFA',F,STAT)
        % STAT = nirs_spm_conman('TFA',F,STAT,STATmode)
        ...
        if ~D                    %-Additional UI setup for main contrast manager
            ...
            if nargin<3
                SPM      = get(F,'UserData');
                xCon     = SPM.xCon;
                nirs_spm_conman('ListCon',findobj(F,'Tag','ConList'),xCon,STAT)
            end
            ...
            nirs_spm_conman('GraphCons',[],[],F)                     %-Clear contrast plot
            nirs_spm_conman('D_Status',F)                            %-Set StatusLine
    ...
    case 'parsecon'                       %-Parse (cell)string into contrast
        %=======================================================================
        % [c,I,emsg,imsg,msg] = nirs_spm_conman('ParseCon',cstr,X,STAT)
    ...
    case 'parseistr'                     %-Parse index string
        %=======================================================================
        % [iX0,I,emsg,imsg] = nirs_spm_conman('ParseIStr',str,max)
    ...
    case 'reset_cb'
        ...
        nirs_spm_conman('ListCon',hConList,xCon,STAT,[])


        %=======================================================================
    case 'd_setup_cb'
        %=======================================================================
        % nirs_spm_conman('D_Setup_CB')
        ...
        nirs_spm_conman('D_TF',F,STAT,STATmode);			%-Setup rest of define UI


        %=======================================================================
    case {'d_conmtx_cb','d_x1cols_cb'}
        %=======================================================================
        % nirs_spm_conman('D_ConMtx_CB')
        % nirs_spm_conman('D_X1cols_CB')
...
%             [c,I,emsg,imsg] = nirs_spm_conman('ParseCon',str,xX.xKXs,STAT);
        [c,I,emsg,imsg] = nirs_spm_conman('ParseCon',str,xX.X,STAT);
            if all(I)
...
%                     DxCon = spm_FcUtil('Set','',STAT,'c',c,xX.xKXs);
        ...
        elseif fcn==2               %-Process column indicies from X1cols widget
            ...
            [iX0,I,emsg,imsg] = nirs_spm_conman('ParseIStr',str,nPar);
        ...
        if all(I)
            ...
            nirs_spm_conman('GraphCons',DxCon,-1,F)		%-Depict contrast
        else
    ...
    case 'd_reset_cb'
        %=======================================================================
        % nirs_spm_conman('D_Reset_CB')

        STAT = get(findobj(gcbf,'Tag','TFA','Value',1),'UserData');
        set(findobj(gcbf,'Tag','D_name'),'String','')		%-Clear name
        set(findobj(gcbf,'Tag','D_ConMtx'),'UserData',[])	%-Contrast definition
        nirs_spm_conman('D_TF',gcbf,STAT);				%-Setup rest of define UI


        %=======================================================================
    case 'd_cancel_cb'
        %=======================================================================
        % nirs_spm_conman('D_Cancel_CB')
        ...
        nirs_spm_conman('StatusLine')


        %=======================================================================
    case 'd_ok_cb'
        %=======================================================================
        % nirs_spm_conman('D_OK_CB')
        ...
        nirs_spm_conman('TFA',F,xCon(end).STAT);			%-Set STAT
        nirs_spm_conman('ListCon',hConList,xCon,xCon(end).STAT,I)	%-ListCon
    ...
    case 'createfig'
        ...
        set([hT,hF,hA],'CallBack','nirs_spm_conman(''TFA'');',...
        ...
        hConList = uicontrol(F,'Style','ListBox','Tag','ConList',...
            ...
            'Max',2,...
            'CallBack','nirs_spm_conman(''ConList_CB'')',...
            'Interruptible','off','BusyAction','Queue',...
            'BackgroundColor','w',...
        ...
        hNew = uicontrol(F,'Style','Pushbutton','String','Define new contrast...',...
            ...
            'ForegroundColor','b',...
            'Callback','nirs_spm_conman(''D_Setup_CB'')',...
            'Enable','on',...
        ...
        uicontrol(F,'Style','Pushbutton','String','Reset',...
            ...
            'ForegroundColor','r',...
            'Callback','nirs_spm_conman(''Reset_CB'')',...
        ...
        uicontrol(F,'Style','Pushbutton','String','Done',...
            ...
            'ForegroundColor','m',...
            'Tag','Done','UserData',1,...
            'Callback','nirs_spm_conman(''Done_CB'')',...
        ...
        if exist('spm_help.m')==2
            uicontrol(F,'Style','Pushbutton','String','?',...
                ...
                'ForegroundColor','g',...
                'Callback','spm_help(''nirs_spm_conman.m'')',...
        ...
        uimenu(h,'Label','Rename selected contrast...',...
            'Tag','CM_Ren',...
            'CallBack','nirs_spm_conman(''Rename_CB'')',...
            'Interruptible','off','BusyAction','Cancel');
        ...
        uimenu(h,'Label','help','Separator','on',...
            'CallBack','spm_help(''nirs_spm_conman'')',...
            'Interruptible','off','BusyAction','Cancel');
        uimenu(h,'Label','crash out','Separator','on',...
            'CallBack','nirs_spm_conman(''Initialise'',''reset'');',...
            'Interruptible','off','BusyAction','Cancel');
        set(h,'CallBack','nirs_spm_conman(''FConMenu_CB'')',...
            'Interruptible','off','BusyAction','Cancel');
        ...
        h = uicontrol(F,'Style','Edit','Tag','D_name',...
            ...
            'Callback','nirs_spm_conman(''D_Status'')','Interruptible','off',...
        ...
        set([hDT,hDF],'CallBack','nirs_spm_conman(''D_TF'');',...
            'Interruptible','off','BusyAction','Queue')
        H = [H,hDT,hDF];
        ...
        h = uicontrol(F,'Style','Edit','Tag','D_ConMtx',...
            ...
            'BackgroundColor',COLOUR,...
            'Max',2,...
            'CallBack','nirs_spm_conman(''D_ConMtx_CB'')',...
            'Interruptible','off','BusyAction','Queue',...
            'UserData',[],...
        ...
        h = uicontrol(F,'Style','Edit','Tag','D_X1cols',...
            ...
            'HorizontalAlignment','Left',...
            'BackgroundColor',COLOUR,...
            'CallBack','nirs_spm_conman(''D_X1cols_CB'')',...
            'Interruptible','off','BusyAction','Queue',...
        ...
        h = uicontrol(F,'Style','Pushbutton','String','Reset',...
            ...
            'ForegroundColor','b',...
            'Callback','nirs_spm_conman(''D_Reset_CB'')',...
            'Interruptible','off','BusyAction','Cancel',...
        ...
        h = uicontrol(F,'Style','Pushbutton','String','Cancel',...
            ...
            'ForegroundColor','r',...
            'Callback','nirs_spm_conman(''D_Cancel_CB'')',...
            'Interruptible','off','BusyAction','Cancel',...
        ...
        h = uicontrol(F,'Style','Pushbutton','String','OK',...
            ...
            'ForegroundColor','m',...
            'Callback','nirs_spm_conman(''D_OK_CB'')',...
            'Interruptible','off','BusyAction','Cancel',...
