...
%
% FORMAT [iX0,I,emsg,imsg] = spm_conman_modified('ParseIStr',str,max)
...
if (nargin==0) | ~ischar(varargin{1})
    %=======================================================================
    % [I,xCon] = spm_conman_modified(xX,xCon,STATmode,n,Prompt,Mcstr,OK2chg)
    ...
    [F,cF] = spm_conman_modified('Initialise','on',SPM,STATmode,n,Prompt,Mcstr,OK2chg);
    ...
    spm_conman_modified('Initialise','off');
...
switch lower(varargin{1}), case 'initialise'
    %=======================================================================
    % [F,cF] = spm_conman_modified('Initialise',Vis,xX,xCon,STATmode,n,Prompt,Mcstr,OK2chg)
    ...
    switch lower(Vis), case 'close'
        ...
        case 'on'
            ...
            if isempty(F)					%-Create ConMan win
                [F,H] = spm_conman_modified('CreateFig');
            else						%-Get handles
            ...
            STAT = spm_conman_modified('TFA',F,'',STATmode);		%-Init. TFA buttons
            set(H.hPrompt,'String',Prompt,'UserData',n)	%-Set prompt
            spm_conman_modified('ImDesMtx',xX,H.hDesMtxAx)		%-Depict DesMtx
            spm_conman_modified('ImParEst',xX,H.hParEstAx)		%-Parameter estimability
            spm_conman_modified('ListCon',H.hConList,xCon,STAT,[])	%-List contrasts
            if OK2chg, tmp='on'; else, tmp='off'; end	%-OK to change xCon?
            set(H.hNew,'Enable',tmp)			%-En/dis-able change UI
            %-****	if isempty(xCon), spm_conman_modified(); end		%-Go straight to DNewUI
    ...
    case 'imdesmtx'
        %=======================================================================
        % spm_conman_modified('ImDesMtx',xX,h)
    ...
    case 'imparest'
        %=======================================================================
        % spm_conman_modified('ImParEst',xX,h)
    ...
    case 'listcon'
        %=======================================================================
        % spm_conman_modified('ListCon',hConList,xCon,STAT,I)
        ...
        spm_conman_modified('GraphCons',xCon,Q(q),get(hConList,'Parent'))
        spm_conman_modified('StatusLine',get(hConList,'Parent'))


        %=======================================================================
    case 'graphcons'
        %=======================================================================
        % spm_conman_modified('GraphCons',xCon,I,F)
    ...
    case 'statusline'
        %=======================================================================
        % spm_conman_modified('StatusLine',F,str,col)
    ...
    case 'conlist_cb'
        %=======================================================================
        % spm_conman_modified('ConList_CB')
        ...
        if strcmp(get(F,'SelectionType'),'open'), spm_conman_modified('Done_CB'), end


        %=======================================================================
    case {'tfa','d_tf'}
        %=======================================================================
        % STAT = spm_conman_modified('TFA')
        % STAT = spm_conman_modified('TFA',F,STAT)
        % STAT = spm_conman_modified('TFA',F,STAT,STATmode)
        ...
        if ~D                    %-Additional UI setup for main contrast manager
            ...
            if nargin<3
                SPM      = get(F,'UserData');
                xCon     = SPM.xCon;
                spm_conman_modified('ListCon',findobj(F,'Tag','ConList'),xCon,STAT)
            end
            ...
            spm_conman_modified('GraphCons',[],[],F)                     %-Clear contrast plot
            spm_conman_modified('D_Status',F)                            %-Set StatusLine
    ...
    case 'fconmenu_cb'
        %=======================================================================
        % spm_conman_modified('FConMenu_CB')
    ...
    case 'parsecon'                       %-Parse (cell)string into contrast
        %=======================================================================
        % [c,I,emsg,imsg,msg] = spm_conman_modified('ParseCon',cstr,X,STAT)
    ...
    case 'parseistr'                     %-Parse index string
        %=======================================================================
        % [iX0,I,emsg,imsg] = spm_conman_modified('ParseIStr',str,max)
    ...
    case 'reset_cb'
        ...
        spm_conman_modified('ListCon',hConList,xCon,STAT,[])


        %=======================================================================
    case 'd_setup_cb'
        %=======================================================================
        % spm_conman_modified('D_Setup_CB')
        ...
        spm_conman_modified('D_TF',F,STAT,STATmode);			%-Setup rest of define UI


        %=======================================================================
    case {'d_conmtx_cb','d_x1cols_cb'}
        %=======================================================================
        % spm_conman_modified('D_ConMtx_CB')
        % spm_conman_modified('D_X1cols_CB')
        ...
        if fcn==1                              %-Parse string from ConMtx widget
            ...
            [c,I,emsg,imsg] = spm_conman_modified('ParseCon',str,xX.xKXs,STAT);
            if all(I)
        ...
        elseif fcn==2               %-Process column indicies from X1cols widget
            ...
            [iX0,I,emsg,imsg] = spm_conman_modified('ParseIStr',str,nPar);
        ...
        if all(I)
            ...
            spm_conman_modified('GraphCons',DxCon,-1,F)		%-Depict contrast
        else
    ...
    case 'd_reset_cb'
        %=======================================================================
        % spm_conman_modified('D_Reset_CB')

        STAT = get(findobj(gcbf,'Tag','TFA','Value',1),'UserData');
        set(findobj(gcbf,'Tag','D_name'),'String','')		%-Clear name
        set(findobj(gcbf,'Tag','D_ConMtx'),'UserData',[])	%-Contrast definition
        spm_conman_modified('D_TF',gcbf,STAT);				%-Setup rest of define UI


        %=======================================================================
    case 'd_cancel_cb'
        %=======================================================================
        % spm_conman_modified('D_Cancel_CB')
        ...
        spm_conman_modified('StatusLine')


        %=======================================================================
    case 'd_ok_cb'
        %=======================================================================
        % spm_conman_modified('D_OK_CB')
        ...
        spm_conman_modified('TFA',F,xCon(end).STAT);			%-Set STAT
        spm_conman_modified('ListCon',hConList,xCon,xCon(end).STAT,I)	%-ListCon
    ...
    case 'd_status'
        %=======================================================================
        % spm_conman_modified('D_Status',F)
        ...
        spm_conman_modified('StatusLine',F,...
    ...
    case 'createfig'
        ...
        set([hT,hF,hA],'CallBack','spm_conman_modified(''TFA'');',...
        ...
        hConList = uicontrol(F,'Style','ListBox','Tag','ConList',...
            ...
            'Max',2,...
            'CallBack','spm_conman_modified(''ConList_CB'')',...
            'Interruptible','off','BusyAction','Queue',...
            'BackgroundColor','w',...
        ...
        hNew = uicontrol(F,'Style','Pushbutton','String','Define new contrast...',...
            ...
            'ForegroundColor','b',...
            'Callback','spm_conman_modified(''D_Setup_CB'')',...
            'Enable','on',...
        ...
        uicontrol(F,'Style','Pushbutton','String','Reset',...
            ...
            'ForegroundColor','r',...
            'Callback','spm_conman_modified(''Reset_CB'')',...
        ...
        uicontrol(F,'Style','Pushbutton','String','Done',...
            ...
            'ForegroundColor','m',...
            'Tag','Done','UserData',1,...
            'Callback','spm_conman_modified(''Done_CB'')',...
        ...
        if exist('spm_help.m')==2
            uicontrol(F,'Style','Pushbutton','String','?',...
                ...
                'ForegroundColor','g',...
                'Callback','spm_help(''spm_conman_modified.m'')',...
        ...
        uimenu(h,'Label','Rename selected contrast...',...
            'Tag','CM_Ren',...
            'CallBack','spm_conman_modified(''Rename_CB'')',...
            'Interruptible','off','BusyAction','Cancel');
        ...
        uimenu(h,'Label','help','Separator','on',...
            'CallBack','spm_help(''spm_conman_modified'')',...
            'Interruptible','off','BusyAction','Cancel');
        uimenu(h,'Label','crash out','Separator','on',...
            'CallBack','spm_conman_modified(''Initialise'',''reset'');',...
            'Interruptible','off','BusyAction','Cancel');
        set(h,'CallBack','spm_conman_modified(''FConMenu_CB'')',...
            'Interruptible','off','BusyAction','Cancel');
        ...
        h = uicontrol(F,'Style','Edit','Tag','D_name',...
            ...
            'Callback','spm_conman_modified(''D_Status'')','Interruptible','off',...
        ...
        set([hDT,hDF],'CallBack','spm_conman_modified(''D_TF'');',...
            'Interruptible','off','BusyAction','Queue')
        H = [H,hDT,hDF];
        ...
        h = uicontrol(F,'Style','Edit','Tag','D_ConMtx',...
            ...
            'BackgroundColor',COLOUR,...
            'Max',2,...
            'CallBack','spm_conman_modified(''D_ConMtx_CB'')',...
            'Interruptible','off','BusyAction','Queue',...
            'UserData',[],...
        ...
        h = uicontrol(F,'Style','Edit','Tag','D_X1cols',...
            ...
            'HorizontalAlignment','Left',...
            'BackgroundColor',COLOUR,...
            'CallBack','spm_conman_modified(''D_X1cols_CB'')',...
            'Interruptible','off','BusyAction','Queue',...
        ...
        h = uicontrol(F,'Style','Pushbutton','String','Reset',...
            ...
            'ForegroundColor','b',...
            'Callback','spm_conman_modified(''D_Reset_CB'')',...
            'Interruptible','off','BusyAction','Cancel',...
        ...
        h = uicontrol(F,'Style','Pushbutton','String','Cancel',...
            ...
            'ForegroundColor','r',...
            'Callback','spm_conman_modified(''D_Cancel_CB'')',...
            'Interruptible','off','BusyAction','Cancel',...
        ...
        h = uicontrol(F,'Style','Pushbutton','String','OK',...
            ...
            'ForegroundColor','m',...
            'Callback','spm_conman_modified(''D_OK_CB'')',...
            'Interruptible','off','BusyAction','Cancel',...
