%DPDWFDJacNB    DPDW Free Space Finite Difference Jacobian Iteration Solution
%
%   [PhiScat PhiInc] = DPDWFDJacNB(CompVol, mu_sp, mu_a, delMu_a, v, f,
...
function [PhiScat, PhiInc] = DPDWFDJacNB(CompVol, mu_sp, mu_a, delMu_a, v, f, ...
    pSrc, ASrc, pDet, ADet, Debug)
...
[PhiScat PhiInc nIter] = Hlm3DScatPntJacNB(CompVol, del_ksq, ksqBkgnd, ...
