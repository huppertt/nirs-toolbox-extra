% MEXTD3PTMB 1st Born approx. of a perturbed Helmholtz equation.
%
%   MEXTD3PTNB computes the forward weighting matrix associated
%   with the Born-1 approximation to a spatial varying k and infinite
%   boundary conditions.
%
