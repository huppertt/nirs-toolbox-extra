% HLMFULLBORNZB Solve full-Born forward problem, semi-infinite boundaries
%
...
function[Phi0, A] = HlmFullBornZB(SD, Medium, MeasList, OptProp, Debug)
...
Img    = Src;
Img(3) = getImageCharge(Src(3), Z0);
PhiImg = FD_GF(Img, Vox, D, K, v); 

% FD_GF returns a photon density, sum charges and turn into a fluence
Phi(nzel) = v * (PhiSrc + -1*PhiImg).';
