% DPDWBORN1ZB    Forward DPDW model using 1st born for a semi-infinte medium.
%
%   The z boundary is assumed to be at z=0.
%
% [Phi0, A] = DPDWBorn1ZB(SD, Medium, MeasList, Method, OptProp, Debug)
%
...
function [Phi0, A] = DPDWBorn1ZB(SD, Medium, MeasList, ...
...
elseif (strcmpi(Method,'FullBorn') | strcmpi(Method,'BornN')    | ...
   ...
   [Phi0, A] = HlmFullBorn_ZB(SD, Medium, MeasList, OptProp, Debug);
...
%   end
%
%   % This part really belongs in HlmFullBorn_ZB as well, but the
...
%   wlst = MeasList(:,4);
%   
%   disp('DPDWBORN1ZB: Hmmm... scaling for FullBorn right?');
