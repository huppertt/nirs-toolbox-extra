% HLMFULLBORNNB Solve full-Born forward problem, infinite boundaries
%
...
function[Phi0, A] = HlmFullBornNB(SD, Medium, MeasList, OptProp, Debug)
...
% FD_GF returns a photon density, turn into a fluence
Phi(nzel) = v * PhiSrc.';
...
% Calculate the self-voxel term
% There is none, because it is zero
